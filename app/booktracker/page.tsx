...
const BookItem = ({
  ...
  return drag(
    <div
      className={`flex items-center p-2 border-b border-amber-200 cursor-move ${
    ...
    >
      ...
      <div className="flex-1">
        <h4 className="text-sm font-medium text-amber-800 line-clamp-1">
          {book.title}
        </h4>
      ...
      <div className="p-4 min-h-48 max-h-48 overflow-y-auto">
        {isLoading ? (
          <div className="flex flex-col items-center justify-center h-32">
            <div className="animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-amber-600 mb-2"></div>
            <p className="text-amber-600 text-sm">Loading books...</p>
          </div>
            ...
            {books.map((book, index) => (
              <li key={index} className="flex items-center space-x-2 group">
                ...
                <div className="flex-1 text-sm">
                  <p className="font-medium line-clamp-1 text-amber-800">
                    {book.title}
                  </p>
...
export default function BookTracker() {
  ...
  const fetchAllMonthlyBooks = async (selectedYear:number) => {
    ...
    try {
      ...
      setIsLoadingMonthlyBooks(false);
    }
  };
      ...
      <DndProvider backend={HTML5Backend}>
        <div className="bg-amber-100 min-h-screen">
          <div className="flex h-screen">
            {/* Sidebar */}
            <div
              className={`bg-amber-200 border-r border-amber-200 overflow-hidden transition-all duration-300 ${
                ...
                <header className="mb-6 flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Track your reading journey throughout the year
                    </p>
                  </div>
                </header>
                        ...
                        <div>
                          ...
                          <div className="mb-4">
                            <p className="text-sm text-gray-600 mb-2">
                              Drag & drop books from the sidebar or select from
                              the list below:
                            </p>
                                ...
                                <div className="space-y-2">
                                  {bookInputs.map((book, index) => (
                                    ...
                                    >
                                      ...
                                      <button
                                        onClick={() =>
                                          removeBookFromSelection(book._id)
                                        }
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                  {months.map((month) => (
                    <MonthCalendar
                      ...
                      isLoading={isLoadingMonthlyBooks}
                    />
                  ))}
                </div>
              </div>
